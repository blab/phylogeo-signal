...
t0 <- Sys.time()
## PPV 
df_params$ppv_conditional_1_jump <- foreach(i_param = 1:nrow(df_params), .combine = 'c') %dopar% {
  ...
  get_ppv_delta_conditional_1_jump(curr_delta, curr_mu, curr_lambda, alpha_GT, beta_GT, 
...
write_csv(df_params, '../results/df_sens_spec_PPV_F1_across_parameter_space_R_1.3_conditional_1_jump.csv')
saveRDS(df_params, '../results/df_sens_spec_PPV_F1_across_parameter_space_R_1.3_conditional_1_jump.rds')
